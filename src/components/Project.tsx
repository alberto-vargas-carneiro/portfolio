...
import port from "../assets/imgs/Sem título.png";
...
export default function Project() {
  return (
    <div id="project" className="mx-[50px] pt-[56px]">
      ...
      <ProjectItem
        ...
        desc2="Para sua construção, optei por utilizar uma poderosa combinação de tecnologias, incluindo o Next.js, que proporciona uma experiência 
        de desenvolvimento eficiente e um desempenho otimizado. Além disso, integrei o React com TypeScript, o que garante um código mais 
        robusto e seguro."
      ...
      <ProjectItem
        ...
        src={kbca}
        alt="KBÇA"
        link="https://alberto-vargas-carneiro.github.io/my-first-site/"
        tag="JavaScript"
        tag2="HTML"
        tag3="CSS"
      ...
      <ProjectItem
        ...
        src={alexa}
        alt="Alexa"
        link="https://alberto-vargas-carneiro.github.io/site-alexa/"
        tag="JavaScript"
        tag2="HTML"
        tag3="CSS"
